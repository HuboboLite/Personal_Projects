...
class Net(nn.Module):
    def __init__(self, in_channels, num_diseases):
        ...
        self.conv5 = self.ConvBlock(512, 256, pool=True)
        self.conv6 = self.ConvBlock(256, 128, pool=True)
        self.res3 = nn.Sequential(self.ConvBlock(128, 128), self.ConvBlock(128, 128))

        self.conv7 = self.ConvBlock(128, 256, pool=True)
        self.conv8 = self.ConvBlock(256, 512, pool=True)
        self.res4 = nn.Sequential(self.ConvBlock(512, 512), self.ConvBlock(512, 512))
